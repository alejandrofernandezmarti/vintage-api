            ...
            <div class="col-md-3">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="{{ route('products.create') }}" class="btn btn-primary">Ir</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.productos.index') }}" class="btn btn-primary">Ir</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card text-center shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.orders.index') }}" class="btn btn-primary">Ir</a>
                    </div>
                </div>
            </div>
        </div>
